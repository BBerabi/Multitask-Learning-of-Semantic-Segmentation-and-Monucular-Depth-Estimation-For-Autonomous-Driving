...
from mtl.models.model_parts import Encoder, get_encoder_channel_counts, ASPP, DecoderDeeplabV3p, \
    SelfAttention, DecoderTransposed, DecoderUnet, DecoderSkip


class ModelSkip(torch.nn.Module):
    def __init__(self, cfg, outputs_desc):
        ...
        print('USING SKIP MODEL :DDDDDDDDDDDDDDD')
        ...
        self.decoder_semseg2 = DecoderSkip(256, ch_out_encoder_2x, ch_out - 1)
        self.decoder_depth2 = DecoderSkip(256, ch_out_encoder_2x, 1)
